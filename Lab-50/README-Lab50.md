...
1. Ingresamos al servicio "IAM" opción "User" y visualizamos la lista de usuarios actuales. Generamos un nuevo usuario IAM "aws-architectassociate" con las siguientes características:
    - User name: aws-architectassociate
    - Select AWS credential type:
        - Access key - Programmatic access
        - Password - AWS Management Console access
    - Console password: Autogenerated password
    - Require password reset: disable
...
10. Realizaremos los siguientes pasos de validación:
    - Recepción de correo electrónico
    - Análisis de políticas asociadas al usuario "ws-architectassociate-2". Se eliminó la política "AdministratorAccess" asociada al usuario
...
12. Realizaremos los siguientes pasos de validación:
    - No existe Recepción de correo electrónico
    - Análisis de políticas asociadas al usuario "ws-architectassociate-3". Se mantiene la política "ReadOnlyAccess"
    - Revisión de los logs generados por la Función Lambda
